...
public class ErroringMessageHandler : CommonBase {
	...
	~ErroringMessageHandler() {
		if (ptr != 0) { Bindings.ErroringMessageHandlerFree(ptr); }
	}
	...
	public static ErroringMessageHandler of() {
		long ret = Bindings.ErroringMessageHandlerNew();
	...
	public MessageSendEventsProvider as_MessageSendEventsProvider() {
		long ret = Bindings.ErroringMessageHandlerAsMessageSendEventsProvider(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public ChannelMessageHandler as_ChannelMessageHandler() {
		long ret = Bindings.ErroringMessageHandlerAsChannelMessageHandler(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }

...
public class RevocationKey : CommonBase {
	...
	~RevocationKey() {
		if (ptr != 0) { Bindings.RevocationKeyFree(ptr); }
	}

	public byte[] get_a() {
		long ret = Bindings.RevocationKeyGetA(this.ptr);
		GC.KeepAlive(this);
	...
	public void set_a(byte[] val) {
		Bindings.RevocationKeySetA(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public static RevocationKey of(byte[] a_arg) {
		long ret = Bindings.RevocationKeyNew(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(a_arg, 33)));
		GC.KeepAlive(a_arg);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public bool eq(org.ldk.structs.RevocationKey b) {
		bool ret = Bindings.RevocationKeyEq(this.ptr, b == null ? 0 : b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
	...
	internal long clone_ptr() {
		long ret = Bindings.RevocationKeyClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public RevocationKey clone() {
		long ret = Bindings.RevocationKeyClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.RevocationKey ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.RevocationKey(null, ret); }
	 ...
	 */
	public long hash() {
		long ret = Bindings.RevocationKeyHash(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public static RevocationKey from_basepoint(org.ldk.structs.RevocationBasepoint countersignatory_basepoint, byte[] per_commitment_point) {
		long ret = Bindings.RevocationKeyFromBasepoint(countersignatory_basepoint == null ? 0 : countersignatory_basepoint.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(per_commitment_point, 33)));
	...
	public byte[] to_public_key() {
		long ret = Bindings.RevocationKeyToPublicKey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.DecodeUint8Array(ret);
		return ret_conv;
	 ...
	 */
	public byte[] write() {
		long ret = Bindings.RevocationKeyWrite(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.DecodeUint8Array(ret);
		return ret_conv;
	...
	public static Result_RevocationKeyDecodeErrorZ read(byte[] ser) {
		long ret = Bindings.RevocationKeyRead(InternalUtils.EncodeUint8Array(ser));
		GC.KeepAlive(ser);
		if (ret >= 0 && ret <= 4096) { return null; }

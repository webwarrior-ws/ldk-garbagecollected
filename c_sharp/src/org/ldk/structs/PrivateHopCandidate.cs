...
public class PrivateHopCandidate : CommonBase {
	...
	~PrivateHopCandidate() {
		if (ptr != 0) { Bindings.PrivateHopCandidateFree(ptr); }
	}

	internal long clone_ptr() {
		long ret = Bindings.PrivateHopCandidateClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public PrivateHopCandidate clone() {
		long ret = Bindings.PrivateHopCandidateClone(this.ptr);
		GC.KeepAlive(this);

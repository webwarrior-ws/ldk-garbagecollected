...
public interface IRoutingMessageHandler {
...
public class RoutingMessageHandler : CommonBase {
	...
	~RoutingMessageHandler() {
		if (ptr != 0) { Bindings.RoutingMessageHandlerFree(ptr); }
	}
	...
	private class LDKRoutingMessageHandlerImpl : Bindings.LDKRoutingMessageHandler {
		internal LDKRoutingMessageHandlerImpl(IRoutingMessageHandler arg, LDKRoutingMessageHandlerHolder impl_holder) { this.arg = arg; this.impl_holder = impl_holder; }
		private IRoutingMessageHandler arg;
		private LDKRoutingMessageHandlerHolder impl_holder;
		public long HandleNodeAnnouncement(long _msg) {
		...
		public long HandleChannelAnnouncement(long _msg) {
		...
		public long HandleChannelUpdate(long _msg) {
		...
		public long GetNextChannelAnnouncement(long _starting_point) {
		...
		public long GetNextNodeAnnouncement(long _starting_point) {
		...
		public long HandleReplyChannelRange(long _their_node_id, long _msg) {
			byte[] _their_node_id_conv = InternalUtils.DecodeUint8Array(_their_node_id);
		...
		public long HandleReplyShortChannelIdsEnd(long _their_node_id, long _msg) {
			byte[] _their_node_id_conv = InternalUtils.DecodeUint8Array(_their_node_id);
		...
		public long HandleQueryChannelRange(long _their_node_id, long _msg) {
			byte[] _their_node_id_conv = InternalUtils.DecodeUint8Array(_their_node_id);
		...
		public long HandleQueryShortChannelIds(long _their_node_id, long _msg) {
			byte[] _their_node_id_conv = InternalUtils.DecodeUint8Array(_their_node_id);
		...
		public bool ProcessingQueueHigh() {
	...
	public static RoutingMessageHandler new_impl(IRoutingMessageHandler arg, IMessageSendEventsProvider messageSendEventsProvider_impl) {
		...
		long[] ptr_idx = Bindings.LDKRoutingMessageHandlerNew(impl, messageSendEventsProvider.instance_idx);
	...
	public Result_boolLightningErrorZ handle_node_announcement(org.ldk.structs.NodeAnnouncement msg) {
		long ret = Bindings.RoutingMessageHandlerHandleNodeAnnouncement(this.ptr, msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(msg);
	...
	public Result_boolLightningErrorZ handle_channel_announcement(org.ldk.structs.ChannelAnnouncement msg) {
		long ret = Bindings.RoutingMessageHandlerHandleChannelAnnouncement(this.ptr, msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_boolLightningErrorZ ret_hu_conv = Result_boolLightningErrorZ.constr_from_ptr(ret);
	...
	public Result_boolLightningErrorZ handle_channel_update(org.ldk.structs.ChannelUpdate msg) {
		long ret = Bindings.RoutingMessageHandlerHandleChannelUpdate(this.ptr, msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_boolLightningErrorZ ret_hu_conv = Result_boolLightningErrorZ.constr_from_ptr(ret);
	...
	public Option_C3Tuple_ChannelAnnouncementChannelUpdateChannelUpdateZZ get_next_channel_announcement(long starting_point) {
		long ret = Bindings.RoutingMessageHandlerGetNextChannelAnnouncement(this.ptr, starting_point);
		GC.KeepAlive(this);
	...
	public NodeAnnouncement get_next_node_announcement(org.ldk.structs.NodeId starting_point) {
		long ret = Bindings.RoutingMessageHandlerGetNextNodeAnnouncement(this.ptr, starting_point == null ? 0 : starting_point.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(starting_point);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public Result_NoneNoneZ peer_connected(byte[] their_node_id, org.ldk.structs.Init init, bool inbound) {
		long ret = Bindings.RoutingMessageHandlerPeerConnected(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)), init == null ? 0 : init.ptr, inbound);
		GC.KeepAlive(this);
	...
	public Result_NoneLightningErrorZ handle_reply_channel_range(byte[] their_node_id, org.ldk.structs.ReplyChannelRange msg) {
		long ret = Bindings.RoutingMessageHandlerHandleReplyChannelRange(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)), msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(their_node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public Result_NoneLightningErrorZ handle_reply_short_channel_ids_end(byte[] their_node_id, org.ldk.structs.ReplyShortChannelIdsEnd msg) {
		long ret = Bindings.RoutingMessageHandlerHandleReplyShortChannelIdsEnd(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)), msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(their_node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public Result_NoneLightningErrorZ handle_query_channel_range(byte[] their_node_id, org.ldk.structs.QueryChannelRange msg) {
		long ret = Bindings.RoutingMessageHandlerHandleQueryChannelRange(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)), msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(their_node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public Result_NoneLightningErrorZ handle_query_short_channel_ids(byte[] their_node_id, org.ldk.structs.QueryShortChannelIds msg) {
		long ret = Bindings.RoutingMessageHandlerHandleQueryShortChannelIds(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)), msg == null ? 0 : msg.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(their_node_id);
		GC.KeepAlive(msg);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public bool processing_queue_high() {
		bool ret = Bindings.RoutingMessageHandlerProcessingQueueHigh(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public NodeFeatures provided_node_features() {
		long ret = Bindings.RoutingMessageHandlerProvidedNodeFeatures(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public InitFeatures provided_init_features(byte[] their_node_id) {
		long ret = Bindings.RoutingMessageHandlerProvidedInitFeatures(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(their_node_id, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(their_node_id);
		if (ret >= 0 && ret <= 4096) { return null; }

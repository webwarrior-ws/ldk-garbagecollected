...
public interface IChannelSigner {
...
public class ChannelSigner : CommonBase {
	...
	~ChannelSigner() {
		if (ptr != 0) { Bindings.ChannelSignerFree(ptr); }
	}
	...
	private class LDKChannelSignerImpl : Bindings.LDKChannelSigner {
		internal LDKChannelSignerImpl(IChannelSigner arg, LDKChannelSignerHolder impl_holder) { this.arg = arg; this.impl_holder = impl_holder; }
		private IChannelSigner arg;
		private LDKChannelSignerHolder impl_holder;
		public long GetPerCommitmentPoint(long _idx) {
			byte[] ret = arg.get_per_commitment_point(_idx);
				GC.KeepAlive(arg);
			long result = InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(ret, 33));
			return result;
		}
		public long ReleaseCommitmentSecret(long _idx) {
			byte[] ret = arg.release_commitment_secret(_idx);
				GC.KeepAlive(arg);
			long result = InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(ret, 32));
			return result;
		}
		public long ValidateHolderCommitment(long _holder_tx, long _outbound_htlc_preimages) {
		...
		public long ValidateCounterpartyRevocation(long _idx, long _secret) {
		...
		public long ChannelKeysId() {
			byte[] ret = arg.channel_keys_id();
				GC.KeepAlive(arg);
			long result = InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(ret, 32));
			return result;
		}
		public void ProvideChannelParameters(long _channel_parameters) {
	...
	public static ChannelSigner new_impl(IChannelSigner arg, ChannelPublicKeys pubkeys) {
		...
		long[] ptr_idx = Bindings.LDKChannelSignerNew(impl, pubkeys == null ? 0 : pubkeys.clone_ptr());
	...
	public byte[] get_per_commitment_point(long idx) {
		long ret = Bindings.ChannelSignerGetPerCommitmentPoint(this.ptr, idx);
		GC.KeepAlive(this);
		GC.KeepAlive(idx);
	...
	public byte[] release_commitment_secret(long idx) {
		long ret = Bindings.ChannelSignerReleaseCommitmentSecret(this.ptr, idx);
		GC.KeepAlive(this);
		GC.KeepAlive(idx);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.DecodeUint8Array(ret);
	...
	public Result_NoneNoneZ validate_holder_commitment(org.ldk.structs.HolderCommitmentTransaction holder_tx, byte[][] outbound_htlc_preimages) {
		long ret = Bindings.ChannelSignerValidateHolderCommitment(this.ptr, holder_tx == null ? 0 : holder_tx.ptr, InternalUtils.EncodeUint64Array(InternalUtils.MapArray(outbound_htlc_preimages, outbound_htlc_preimages_conv_8 => InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(outbound_htlc_preimages_conv_8, 32)))));
		GC.KeepAlive(this);
	...
	public Result_NoneNoneZ validate_counterparty_revocation(long idx, byte[] secret) {
		long ret = Bindings.ChannelSignerValidateCounterpartyRevocation(this.ptr, idx, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(secret, 32)));
		GC.KeepAlive(this);
		GC.KeepAlive(idx);
		GC.KeepAlive(secret);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public byte[] channel_keys_id() {
		long ret = Bindings.ChannelSignerChannelKeysId(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.DecodeUint8Array(ret);
		return ret_conv;
	...
	public void provide_channel_parameters(org.ldk.structs.ChannelTransactionParameters channel_parameters) {
		Bindings.ChannelSignerProvideChannelParameters(this.ptr, channel_parameters == null ? 0 : channel_parameters.ptr);
		GC.KeepAlive(this);
	...
	public ChannelPublicKeys get_pubkeys() {
		long ret = Bindings.ChannelSignerGetPubkeys(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }

...
public class Result_RouteLightningErrorZ : CommonBase {
	...
	~Result_RouteLightningErrorZ() {
		if (ptr != 0) { Bindings.CResultRouteLightningErrorZFree(ptr); }
	}

	internal static Result_RouteLightningErrorZ constr_from_ptr(long ptr) {
		if (Bindings.CResultRouteLightningErrorZIsOk(ptr)) {
	...
	public class Result_RouteLightningErrorZ_OK : Result_RouteLightningErrorZ {
		...
		internal Result_RouteLightningErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
			long res = Bindings.CResultRouteLightningErrorZGetOk(ptr);
	...
	public class Result_RouteLightningErrorZ_Err : Result_RouteLightningErrorZ {
		...
		internal Result_RouteLightningErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
			long err = Bindings.CResultRouteLightningErrorZGetErr(ptr);
	...
	public static Result_RouteLightningErrorZ ok(org.ldk.structs.Route o) {
		long ret = Bindings.CResultRouteLightningErrorZOk(o == null ? 0 : o.ptr);
		GC.KeepAlive(o);
	...
	public static Result_RouteLightningErrorZ err(org.ldk.structs.LightningError e) {
		long ret = Bindings.CResultRouteLightningErrorZErr(e == null ? 0 : e.ptr);
		GC.KeepAlive(e);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_RouteLightningErrorZ ret_hu_conv = Result_RouteLightningErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public bool is_ok() {
		bool ret = Bindings.CResultRouteLightningErrorZIsOk(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}

	internal long clone_ptr() {
		long ret = Bindings.CResultRouteLightningErrorZClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public Result_RouteLightningErrorZ clone() {
		long ret = Bindings.CResultRouteLightningErrorZClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_RouteLightningErrorZ ret_hu_conv = Result_RouteLightningErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;

...
public class ErroneousField : CommonBase {
	...
	~ErroneousField() {
		if (ptr != 0) { Bindings.ErroneousFieldFree(ptr); }
	}
	...
	public long get_tlv_fieldnum() {
		long ret = Bindings.ErroneousFieldGetTlvFieldnum(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public void set_tlv_fieldnum(long val) {
		Bindings.ErroneousFieldSetTlvFieldnum(this.ptr, val);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public Option_CVec_u8ZZ get_suggested_value() {
		long ret = Bindings.ErroneousFieldGetSuggestedValue(this.ptr);
		GC.KeepAlive(this);
	...
	public void set_suggested_value(org.ldk.structs.Option_CVec_u8ZZ val) {
		Bindings.ErroneousFieldSetSuggestedValue(this.ptr, val.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	...
	public static ErroneousField of(long tlv_fieldnum_arg, org.ldk.structs.Option_CVec_u8ZZ suggested_value_arg) {
		long ret = Bindings.ErroneousFieldNew(tlv_fieldnum_arg, suggested_value_arg.ptr);
	...
	internal long clone_ptr() {
		long ret = Bindings.ErroneousFieldClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public ErroneousField clone() {
		long ret = Bindings.ErroneousFieldClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.ErroneousField ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.ErroneousField(null, ret); }
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(this); };

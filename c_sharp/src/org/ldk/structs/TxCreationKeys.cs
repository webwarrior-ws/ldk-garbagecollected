...
public class TxCreationKeys : CommonBase {
	...
	~TxCreationKeys() {
		if (ptr != 0) { Bindings.TxCreationKeysFree(ptr); }
	}
	...
	public byte[] get_per_commitment_point() {
		long ret = Bindings.TxCreationKeysGetPerCommitmentPoint(this.ptr);
		GC.KeepAlive(this);
	...
	public void set_per_commitment_point(byte[] val) {
		Bindings.TxCreationKeysSetPerCommitmentPoint(this.ptr, InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(val, 33)));
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	}
	...
	public RevocationKey get_revocation_key() {
		long ret = Bindings.TxCreationKeysGetRevocationKey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public void set_revocation_key(org.ldk.structs.RevocationKey val) {
		Bindings.TxCreationKeysSetRevocationKey(this.ptr, val == null ? 0 : val.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
	...
	public HtlcKey get_broadcaster_htlc_key() {
		long ret = Bindings.TxCreationKeysGetBroadcasterHtlcKey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public void set_broadcaster_htlc_key(org.ldk.structs.HtlcKey val) {
		Bindings.TxCreationKeysSetBroadcasterHtlcKey(this.ptr, val == null ? 0 : val.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
		if (this != null) { this.ptrs_to.AddLast(val); };
	}
	...
	public HtlcKey get_countersignatory_htlc_key() {
		long ret = Bindings.TxCreationKeysGetCountersignatoryHtlcKey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.HtlcKey ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.HtlcKey(null, ret); }
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(this); };
	...
	public void set_countersignatory_htlc_key(org.ldk.structs.HtlcKey val) {
		Bindings.TxCreationKeysSetCountersignatoryHtlcKey(this.ptr, val == null ? 0 : val.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
		if (this != null) { this.ptrs_to.AddLast(val); };
	}
	...
	public DelayedPaymentKey get_broadcaster_delayed_payment_key() {
		long ret = Bindings.TxCreationKeysGetBroadcasterDelayedPaymentKey(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public void set_broadcaster_delayed_payment_key(org.ldk.structs.DelayedPaymentKey val) {
		Bindings.TxCreationKeysSetBroadcasterDelayedPaymentKey(this.ptr, val == null ? 0 : val.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(val);
		if (this != null) { this.ptrs_to.AddLast(val); };
	}
	...
	public static TxCreationKeys of(byte[] per_commitment_point_arg, org.ldk.structs.RevocationKey revocation_key_arg, org.ldk.structs.HtlcKey broadcaster_htlc_key_arg, org.ldk.structs.HtlcKey countersignatory_htlc_key_arg, org.ldk.structs.DelayedPaymentKey broadcaster_delayed_payment_key_arg) {
		long ret = Bindings.TxCreationKeysNew(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(per_commitment_point_arg, 33)), revocation_key_arg == null ? 0 : revocation_key_arg.ptr, broadcaster_htlc_key_arg == null ? 0 : broadcaster_htlc_key_arg.ptr, countersignatory_htlc_key_arg == null ? 0 : countersignatory_htlc_key_arg.ptr, broadcaster_delayed_payment_key_arg == null ? 0 : broadcaster_delayed_payment_key_arg.ptr);
	...
	public bool eq(org.ldk.structs.TxCreationKeys b) {
		bool ret = Bindings.TxCreationKeysEq(this.ptr, b == null ? 0 : b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
	...
	internal long clone_ptr() {
		long ret = Bindings.TxCreationKeysClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public TxCreationKeys clone() {
		long ret = Bindings.TxCreationKeysClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.TxCreationKeys ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.TxCreationKeys(null, ret); }
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(this); };
	 ...
	 */
	public byte[] write() {
		long ret = Bindings.TxCreationKeysWrite(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		byte[] ret_conv = InternalUtils.DecodeUint8Array(ret);
		return ret_conv;
	...
	public static Result_TxCreationKeysDecodeErrorZ read(byte[] ser) {
		long ret = Bindings.TxCreationKeysRead(InternalUtils.EncodeUint8Array(ser));
		GC.KeepAlive(ser);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public static TxCreationKeys from_channel_static_keys(byte[] per_commitment_point, org.ldk.structs.ChannelPublicKeys broadcaster_keys, org.ldk.structs.ChannelPublicKeys countersignatory_keys) {
		long ret = Bindings.TxCreationKeysFromChannelStaticKeys(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(per_commitment_point, 33)), broadcaster_keys == null ? 0 : broadcaster_keys.ptr, countersignatory_keys == null ? 0 : countersignatory_keys.ptr);
		GC.KeepAlive(per_commitment_point);

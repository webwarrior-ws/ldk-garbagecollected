...
public class CandidateRouteHop : CommonBase {
	...
	~CandidateRouteHop() {
		if (ptr != 0) { Bindings.CandidateRouteHopFree(ptr); }
	}

	internal static CandidateRouteHop constr_from_ptr(long ptr) {
		long raw_ty = Bindings.LDKCandidateRouteHopTyFromPtr(ptr);
		switch (raw_ty) {
	...
	public class CandidateRouteHop_FirstHop : CandidateRouteHop {
		...
		internal CandidateRouteHop_FirstHop(long ptr) : base(null, ptr) {
			long first_hop = Bindings.LDKCandidateRouteHopFirstHopGetFirstHop(ptr);
	...
	public class CandidateRouteHop_PublicHop : CandidateRouteHop {
		...
		internal CandidateRouteHop_PublicHop(long ptr) : base(null, ptr) {
			long public_hop = Bindings.LDKCandidateRouteHopPublicHopGetPublicHop(ptr);
	...
	public class CandidateRouteHop_PrivateHop : CandidateRouteHop {
		...
		internal CandidateRouteHop_PrivateHop(long ptr) : base(null, ptr) {
			long private_hop = Bindings.LDKCandidateRouteHopPrivateHopGetPrivateHop(ptr);
	...
	public class CandidateRouteHop_Blinded : CandidateRouteHop {
		...
		internal CandidateRouteHop_Blinded(long ptr) : base(null, ptr) {
			long blinded = Bindings.LDKCandidateRouteHopBlindedGetBlinded(ptr);
	...
	public class CandidateRouteHop_OneHopBlinded : CandidateRouteHop {
		...
		internal CandidateRouteHop_OneHopBlinded(long ptr) : base(null, ptr) {
			long one_hop_blinded = Bindings.LDKCandidateRouteHopOneHopBlindedGetOneHopBlinded(ptr);
	...
	internal long clone_ptr() {
		long ret = Bindings.CandidateRouteHopClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public CandidateRouteHop clone() {
		long ret = Bindings.CandidateRouteHopClone(this.ptr);
		GC.KeepAlive(this);
	...
	public static CandidateRouteHop first_hop(org.ldk.structs.FirstHopCandidate a) {
		long ret = Bindings.CandidateRouteHopFirstHop(a == null ? 0 : a.ptr);
		GC.KeepAlive(a);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.CandidateRouteHop ret_hu_conv = org.ldk.structs.CandidateRouteHop.constr_from_ptr(ret);
	...
	public static CandidateRouteHop public_hop(org.ldk.structs.PublicHopCandidate a) {
		long ret = Bindings.CandidateRouteHopPublicHop(a == null ? 0 : a.ptr);
		GC.KeepAlive(a);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.CandidateRouteHop ret_hu_conv = org.ldk.structs.CandidateRouteHop.constr_from_ptr(ret);
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(ret_hu_conv); };
	...
	public static CandidateRouteHop private_hop(org.ldk.structs.PrivateHopCandidate a) {
		long ret = Bindings.CandidateRouteHopPrivateHop(a == null ? 0 : a.ptr);
		GC.KeepAlive(a);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.CandidateRouteHop ret_hu_conv = org.ldk.structs.CandidateRouteHop.constr_from_ptr(ret);
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(ret_hu_conv); };
	...
	public static CandidateRouteHop blinded(org.ldk.structs.BlindedPathCandidate a) {
		long ret = Bindings.CandidateRouteHopBlinded(a == null ? 0 : a.ptr);
		GC.KeepAlive(a);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.CandidateRouteHop ret_hu_conv = org.ldk.structs.CandidateRouteHop.constr_from_ptr(ret);
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(ret_hu_conv); };
	...
	public static CandidateRouteHop one_hop_blinded(org.ldk.structs.OneHopBlindedPathCandidate a) {
		long ret = Bindings.CandidateRouteHopOneHopBlinded(a == null ? 0 : a.ptr);
		GC.KeepAlive(a);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.CandidateRouteHop ret_hu_conv = org.ldk.structs.CandidateRouteHop.constr_from_ptr(ret);
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(ret_hu_conv); };
	...
	public Option_u64Z globally_unique_short_channel_id() {
		long ret = Bindings.CandidateRouteHopGloballyUniqueShortChannelId(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public int cltv_expiry_delta() {
		int ret = Bindings.CandidateRouteHopCltvExpiryDelta(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public long htlc_minimum_msat() {
		long ret = Bindings.CandidateRouteHopHtlcMinimumMsat(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public RoutingFees fees() {
		long ret = Bindings.CandidateRouteHopFees(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public NodeId source() {
		long ret = Bindings.CandidateRouteHopSource(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
	...
	public NodeId target() {
		long ret = Bindings.CandidateRouteHopTarget(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.NodeId ret_hu_conv = null; if (ret < 0 || ret > 4096) { ret_hu_conv = new org.ldk.structs.NodeId(null, ret); }
		if (ret_hu_conv != null) { ret_hu_conv.ptrs_to.AddLast(this); };

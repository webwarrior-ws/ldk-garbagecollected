...
public class Result_RouteDecodeErrorZ : CommonBase {
	...
	~Result_RouteDecodeErrorZ() {
		if (ptr != 0) { Bindings.CResultRouteDecodeErrorZFree(ptr); }
	}

	internal static Result_RouteDecodeErrorZ constr_from_ptr(long ptr) {
		if (Bindings.CResultRouteDecodeErrorZIsOk(ptr)) {
	...
	public class Result_RouteDecodeErrorZ_OK : Result_RouteDecodeErrorZ {
		...
		internal Result_RouteDecodeErrorZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
			long res = Bindings.CResultRouteDecodeErrorZGetOk(ptr);
	...
	public class Result_RouteDecodeErrorZ_Err : Result_RouteDecodeErrorZ {
		...
		internal Result_RouteDecodeErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
			long err = Bindings.CResultRouteDecodeErrorZGetErr(ptr);
	...
	public static Result_RouteDecodeErrorZ ok(org.ldk.structs.Route o) {
		long ret = Bindings.CResultRouteDecodeErrorZOk(o == null ? 0 : o.ptr);
		GC.KeepAlive(o);
	...
	public static Result_RouteDecodeErrorZ err(org.ldk.structs.DecodeError e) {
		long ret = Bindings.CResultRouteDecodeErrorZErr(e.ptr);
		GC.KeepAlive(e);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_RouteDecodeErrorZ ret_hu_conv = Result_RouteDecodeErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public bool is_ok() {
		bool ret = Bindings.CResultRouteDecodeErrorZIsOk(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}

	internal long clone_ptr() {
		long ret = Bindings.CResultRouteDecodeErrorZClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public Result_RouteDecodeErrorZ clone() {
		long ret = Bindings.CResultRouteDecodeErrorZClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_RouteDecodeErrorZ ret_hu_conv = Result_RouteDecodeErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;

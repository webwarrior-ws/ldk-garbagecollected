...
public class RecentPaymentDetails : CommonBase {
	...
	~RecentPaymentDetails() {
		if (ptr != 0) { Bindings.RecentPaymentDetailsFree(ptr); }
	}

	internal static RecentPaymentDetails constr_from_ptr(long ptr) {
		long raw_ty = Bindings.LDKRecentPaymentDetailsTyFromPtr(ptr);
		switch (raw_ty) {
	...
	public class RecentPaymentDetails_AwaitingInvoice : RecentPaymentDetails {
		...
		internal RecentPaymentDetails_AwaitingInvoice(long ptr) : base(null, ptr) {
			long payment_id = Bindings.LDKRecentPaymentDetailsAwaitingInvoiceGetPaymentId(ptr);
	...
	public class RecentPaymentDetails_Pending : RecentPaymentDetails {
		...
		internal RecentPaymentDetails_Pending(long ptr) : base(null, ptr) {
			long payment_id = Bindings.LDKRecentPaymentDetailsPendingGetPaymentId(ptr);
			byte[] payment_id_conv = InternalUtils.DecodeUint8Array(payment_id);
			this.payment_id = payment_id_conv;
			long payment_hash = Bindings.LDKRecentPaymentDetailsPendingGetPaymentHash(ptr);
			byte[] payment_hash_conv = InternalUtils.DecodeUint8Array(payment_hash);
			this.payment_hash = payment_hash_conv;
			this.total_msat = Bindings.LDKRecentPaymentDetailsPendingGetTotalMsat(ptr);
		}
	}
	...
	public class RecentPaymentDetails_Fulfilled : RecentPaymentDetails {
		...
		internal RecentPaymentDetails_Fulfilled(long ptr) : base(null, ptr) {
			long payment_id = Bindings.LDKRecentPaymentDetailsFulfilledGetPaymentId(ptr);
			byte[] payment_id_conv = InternalUtils.DecodeUint8Array(payment_id);
			this.payment_id = payment_id_conv;
			long payment_hash = Bindings.LDKRecentPaymentDetailsFulfilledGetPaymentHash(ptr);
	...
	public class RecentPaymentDetails_Abandoned : RecentPaymentDetails {
		...
		internal RecentPaymentDetails_Abandoned(long ptr) : base(null, ptr) {
			long payment_id = Bindings.LDKRecentPaymentDetailsAbandonedGetPaymentId(ptr);
			byte[] payment_id_conv = InternalUtils.DecodeUint8Array(payment_id);
			this.payment_id = payment_id_conv;
			long payment_hash = Bindings.LDKRecentPaymentDetailsAbandonedGetPaymentHash(ptr);
			byte[] payment_hash_conv = InternalUtils.DecodeUint8Array(payment_hash);
			this.payment_hash = payment_hash_conv;
		}
	}
	internal long clone_ptr() {
		long ret = Bindings.RecentPaymentDetailsClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public RecentPaymentDetails clone() {
		long ret = Bindings.RecentPaymentDetailsClone(this.ptr);
		GC.KeepAlive(this);
	...
	public static RecentPaymentDetails awaiting_invoice(byte[] payment_id) {
		long ret = Bindings.RecentPaymentDetailsAwaitingInvoice(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_id, 32)));
	...
	public static RecentPaymentDetails pending(byte[] payment_id, byte[] payment_hash, long total_msat) {
		long ret = Bindings.RecentPaymentDetailsPending(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_id, 32)), InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_hash, 32)), total_msat);
		GC.KeepAlive(payment_id);
	...
	public static RecentPaymentDetails fulfilled(byte[] payment_id, org.ldk.structs.Option_ThirtyTwoBytesZ payment_hash) {
		long ret = Bindings.RecentPaymentDetailsFulfilled(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_id, 32)), payment_hash.ptr);
		GC.KeepAlive(payment_id);
		GC.KeepAlive(payment_hash);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.RecentPaymentDetails ret_hu_conv = org.ldk.structs.RecentPaymentDetails.constr_from_ptr(ret);
	...
	public static RecentPaymentDetails abandoned(byte[] payment_id, byte[] payment_hash) {
		long ret = Bindings.RecentPaymentDetailsAbandoned(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_id, 32)), InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(payment_hash, 32)));
		GC.KeepAlive(payment_id);
		GC.KeepAlive(payment_hash);
		if (ret >= 0 && ret <= 4096) { return null; }
		org.ldk.structs.RecentPaymentDetails ret_hu_conv = org.ldk.structs.RecentPaymentDetails.constr_from_ptr(ret);

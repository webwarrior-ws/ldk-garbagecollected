...
public class Result_NonePeerHandleErrorZ : CommonBase {
	...
	~Result_NonePeerHandleErrorZ() {
		if (ptr != 0) { Bindings.CResultNonePeerHandleErrorZFree(ptr); }
	}

	internal static Result_NonePeerHandleErrorZ constr_from_ptr(long ptr) {
		if (Bindings.CResultNonePeerHandleErrorZIsOk(ptr)) {
	...
	public class Result_NonePeerHandleErrorZ_Err : Result_NonePeerHandleErrorZ {
		...
		internal Result_NonePeerHandleErrorZ_Err(object _dummy, long ptr) : base(_dummy, ptr) {
			long err = Bindings.CResultNonePeerHandleErrorZGetErr(ptr);
	...
	public static Result_NonePeerHandleErrorZ ok() {
		long ret = Bindings.CResultNonePeerHandleErrorZOk();
	...
	public static Result_NonePeerHandleErrorZ err(org.ldk.structs.PeerHandleError e) {
		long ret = Bindings.CResultNonePeerHandleErrorZErr(e == null ? 0 : e.ptr);
		GC.KeepAlive(e);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_NonePeerHandleErrorZ ret_hu_conv = Result_NonePeerHandleErrorZ.constr_from_ptr(ret);
	 ...
	 */
	public bool is_ok() {
		bool ret = Bindings.CResultNonePeerHandleErrorZIsOk(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}

	internal long clone_ptr() {
		long ret = Bindings.CResultNonePeerHandleErrorZClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public Result_NonePeerHandleErrorZ clone() {
		long ret = Bindings.CResultNonePeerHandleErrorZClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_NonePeerHandleErrorZ ret_hu_conv = Result_NonePeerHandleErrorZ.constr_from_ptr(ret);
		return ret_hu_conv;

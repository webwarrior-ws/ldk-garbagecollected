...
public class Payee : CommonBase {
	...
	~Payee() {
		if (ptr != 0) { Bindings.PayeeFree(ptr); }
	}

	internal static Payee constr_from_ptr(long ptr) {
		long raw_ty = Bindings.LDKPayeeTyFromPtr(ptr);
		switch (raw_ty) {
	...
	public class Payee_Blinded : Payee {
		...
		internal Payee_Blinded(long ptr) : base(null, ptr) {
			long route_hints = Bindings.LDKPayeeBlindedGetRouteHints(ptr);
			...
			Bindings.FreeBuffer(route_hints);
			this.route_hints = route_hints_conv_37_arr;
			long features = Bindings.LDKPayeeBlindedGetFeatures(ptr);
	...
	public class Payee_Clear : Payee {
		...
		internal Payee_Clear(long ptr) : base(null, ptr) {
			long node_id = Bindings.LDKPayeeClearGetNodeId(ptr);
			byte[] node_id_conv = InternalUtils.DecodeUint8Array(node_id);
			this.node_id = node_id_conv;
			long route_hints = Bindings.LDKPayeeClearGetRouteHints(ptr);
			...
			long features = Bindings.LDKPayeeClearGetFeatures(ptr);
			...
			if (features_hu_conv != null) { features_hu_conv.ptrs_to.AddLast(this); };
			this.features = features_hu_conv;
			this.final_cltv_expiry_delta = Bindings.LDKPayeeClearGetFinalCltvExpiryDelta(ptr);
		}
	}
	internal long clone_ptr() {
		long ret = Bindings.PayeeClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	 ...
	 */
	public Payee clone() {
		long ret = Bindings.PayeeClone(this.ptr);
		GC.KeepAlive(this);
	...
	public static Payee blinded(TwoTuple_BlindedPayInfoBlindedPathZ[] route_hints, org.ldk.structs.Bolt12InvoiceFeatures features) {
		long ret = Bindings.PayeeBlinded(InternalUtils.EncodeUint64Array(InternalUtils.MapArray(route_hints, route_hints_conv_37 => route_hints_conv_37 != null ? route_hints_conv_37.ptr : 0)), features == null ? 0 : features.ptr);
	...
	public static Payee clear(byte[] node_id, RouteHint[] route_hints, org.ldk.structs.Bolt11InvoiceFeatures features, int final_cltv_expiry_delta) {
		long ret = Bindings.PayeeClear(InternalUtils.EncodeUint8Array(InternalUtils.CheckArrLen(node_id, 33)), InternalUtils.EncodeUint64Array(InternalUtils.MapArray(route_hints, route_hints_conv_11 => route_hints_conv_11 == null ? 0 : route_hints_conv_11.ptr)), features == null ? 0 : features.ptr, final_cltv_expiry_delta);
	 ...
	 */
	public long hash() {
		long ret = Bindings.PayeeHash(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public bool eq(org.ldk.structs.Payee b) {
		bool ret = Bindings.PayeeEq(this.ptr, b == null ? 0 : b.ptr);
		GC.KeepAlive(this);
		GC.KeepAlive(b);
		return ret;
	}

...
public class Result_ShutdownScriptNoneZ : CommonBase {
	...
	~Result_ShutdownScriptNoneZ() {
		if (ptr != 0) { Bindings.CResultShutdownScriptNoneZFree(ptr); }
	}

	internal static Result_ShutdownScriptNoneZ constr_from_ptr(long ptr) {
		if (Bindings.CResultShutdownScriptNoneZIsOk(ptr)) {
	...
	public class Result_ShutdownScriptNoneZ_OK : Result_ShutdownScriptNoneZ {
		...
		internal Result_ShutdownScriptNoneZ_OK(object _dummy, long ptr) : base(_dummy, ptr) {
			long res = Bindings.CResultShutdownScriptNoneZGetOk(ptr);
	...
	public static Result_ShutdownScriptNoneZ ok(org.ldk.structs.ShutdownScript o) {
		long ret = Bindings.CResultShutdownScriptNoneZOk(o == null ? 0 : o.ptr);
		GC.KeepAlive(o);
	...
	public static Result_ShutdownScriptNoneZ err() {
		long ret = Bindings.CResultShutdownScriptNoneZErr();
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_ShutdownScriptNoneZ ret_hu_conv = Result_ShutdownScriptNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
	}
	 ...
	 */
	public bool is_ok() {
		bool ret = Bindings.CResultShutdownScriptNoneZIsOk(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}

	internal long clone_ptr() {
		long ret = Bindings.CResultShutdownScriptNoneZClonePtr(this.ptr);
		GC.KeepAlive(this);
		return ret;
	}
	...
	public Result_ShutdownScriptNoneZ clone() {
		long ret = Bindings.CResultShutdownScriptNoneZClone(this.ptr);
		GC.KeepAlive(this);
		if (ret >= 0 && ret <= 4096) { return null; }
		Result_ShutdownScriptNoneZ ret_hu_conv = Result_ShutdownScriptNoneZ.constr_from_ptr(ret);
		return ret_hu_conv;
